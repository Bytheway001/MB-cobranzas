...
export const ExpensesList = ({ expenses, setCorrection }) => {
    ...
    const columns = [
        ...
        { dataField: 'account.name', text: 'Cuenta', sort: true, filter: selectFilter({ options: accounts, className: 'form-control-sm', placeholder: 'Todas' }), headerStyle: { width: 150 } },
        { dataField: 'description', text: 'Descripcion' },
        { dataField: 'category.name', text: 'Categoria', filter: selectFilter({ options: categories, className: 'form-control-sm', placeholder: 'Todas' }), headerStyle: { width: 300 } },
        ...
        { dataField: 'currency', text: 'Moneda', sort: true, filter: selectFilter({ options: currencies, className: 'form-control form-control-sm', placeholder: 'Todas' }), headerStyle: { width: 80 } },
                ...
                <>
                    {!row.corrected_with &&
                        <ButtonGroup size='sm'>
                            ...
                            <Button size='sm' onClick={() => setCorrection({ type: 'expenses', row: row, user_id: row.user_id, user: row.user })} >
