...

                    {
                        report && (
                            <Tabs defaultActiveKey="expenses" id="uncontrolled-tab-example">
                                ...
                                <Tab eventKey="policy_payments" title="Pago de Polizas" className={`p-3 ${user.role !== 'master' ? 'd-none' : ""}`}>
                                    {user.role === 'master' ? <PolicyPaymentsList payments={report.policy_payments} setCorrection={setCorrection} /> : <p>No tiene permisos para ver esta informacion</p>}
                                </Tab>
                                        ...
                                        <Row>
                                                ...
                                                <Card>
                                                    ...
                                                    <Card.Body>
                                                        <Table variant='striped' size='sm'>
                                                            ...
                                                            <tbody>
                                                                {
                                                                    accounts.length > 0 && accounts.filter(x => x.type === 'Bank' || x.type === 'Checks').map((account, key) => (
                                                                        <tr key={key}>
                                            ...
                                            <Col sm={6}>
                                                <Card className='h-100'>
                                                    ...
                                                    <Card.Body>
                                                        <Extracto bob={saldo.BOB} usd={saldo.USD} show={modalshow} setShow={setModalShow} data={modalData} />
                                                        <Table variant='striped' size='sm'>
                                                            <thead>
                                                                <tr className='bg-info text-white'>
                                                                    <th>Cuenta</th>
