...
export const Validators = {
	...
	mustBeEmail: value => /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test(value) ? undefined : "Debe escribir una direccion valida de correo",
	mustBeDecimal: value =>{ 
	...
	mustBeLowerThan: (value, top) => { return (value <= (top.premium - top.payed)) ? undefined : "El monto supera la cantidad adeudada por el cliente" },
	...
	isDifferent: (value, allValues) => { let response = value !== allValues.from ? undefined : "Las cuentas deben ser distintas"; return response },
