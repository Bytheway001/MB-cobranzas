...
export const ClientProfileTable = ({ client }) => {
    ...
    return (
        <Table size='sm' variant='bordered' style={{ fontSize: '0.8em' }}>
            <thead>
                <tr>
                    <th className='bg-primary text-white text-center' colSpan={4}>Datos de Poliza</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td>{policy.plan.name} - {formatMoney(policy.option, 2, '.', ',', '$')}</td>
                ...
                <tr>
                    ...
                    <th><a href={'https://app.hubspot.com/contacts/4019934/contact/' + client.h_id} target='blank'>{client.h_id}</a></th>
                </tr>
            </tbody>
            <tfoot>
                <tr>
